...
<html lang="en">
    <head>
        ...
        <title>Results</title>
        <link rel="icon" type="image/x-icon" href="res2.jpg">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                <h1 class="title" align="center">SRKR ENGINEERING COLLEGE (Autonomous)</h1>
                                    <h4 style="padding-left:450px; margin:1vh;">R20 EXAMINATION RESULT </h4>
                                    <h6 style="padding-left:470px; margin:1vh;"> Chinaamiram, Bhimavaram. </h6>
                                </div>
                            </div>
                            <!-- /.row -->
                        ...
                        <!-- /.container-fluid -->
                        <div class="" style="padding-left:1150px; margin-top:10px;">
                            <button type="button" class="but"><a href="../../surya/index.html">Log Out</a></button>
                        </div>
...
<tr>
                                                <th scope="row" colspan="2">Download Result</th>           
                                                            <td><b><a href="../fp.html">Download </a> </b></td>
                                                             </tr>
...
?>
                                    ...
                                    <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                               <button type="button" class="but"><a href="https://docs.google.com/forms/d/e/1FAIpQLSfD3fQofDpxWKMscGmNC0TsNcE63s1s-JT7CuDuu9UjDOmZsw/viewform?vc=0&c=0&w=1&flr=0" target="_blank">Feedback Form</a></button>
                                                            </div>
                                                        </div>
