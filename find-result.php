...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="res1.png">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center" style="padding-right:20px;">
...
<?php }} ?>
                                    ...
                                    <div class="form-group mt-20">
                                        <div class="">
                                            ...
                                            <button type="submit" class="btn btn-success btn-labeled pull-right" href="result.php">Search<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>

                                       <div class="col-sm-6">
                                                               <a href="../login/stu_login.html">Log-Out</a>
                                                            </div>
                                </form>
